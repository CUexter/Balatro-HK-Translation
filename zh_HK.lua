return {
	...
	misc = {
		...
		dictionary = {
			...
			mp_mod_singleplayer = "單人遊戲",
			mp_mod_join_lobby = "加入大廳",
			mp_mod_return_lobby = "返回大廳",
			mp_mod_reconnect = "重新連線",
			mp_mod_desc = "令到你可以同其他人對戰",
			mp_mod_create_lobby = "建立大廳",
			mp_mod_start_lobby = "開放大廳",
			mp_mod_enemy_score = "宜家對手嘅分數",
			mp_mod_enemy_hands = "敵人淨返手牌數",
			mp_mod_coming_soon = "即將推出",
			mp_mod_ready = "預備下一回合",
			mp_mod_unready = "取消預備",
			mp_mod_wait_enemy = "等待對手完成...",
			mp_mod_lives = "淨低命數",
			mp_mod_leave_lobby = "離開大廳",
			mp_mod_lost_life = " 冇咗條命 ",
			mp_mod_failed = " 失敗咗 ",
			mp_mod_defeat_enemy = "贏咗對手",
			mp_mod_total_lives_lost = "總共損失命數 (每條命 $4)",
			mp_mod_attrition_name = "消耗戰",
			mp_mod_attrition_desc = "每個Boss 回合都係玩家之間嘅比賽， 得分較低嘅玩家會損失一條命",
			mp_mod_draft_name = "選拔戰",
			mp_mod_draft_desc = "雙方玩家會玩三次正常嘅底注， 然後佢哋會玩一次底注， 每回合分數較低嘅人會損失一條命",
			mp_mod_royale_name = "大亂鬥",
			mp_mod_royale_desc = "好似消耗戰咁，但係有八個玩家同埋每人都只有一條命",
			mp_mod_vanilla_plus_name = "經典+",
			mp_mod_vp_desc = "第一個輸嘅人就輸，冇PVP嘅盲注",
			mp_mod_headup_name = "先拔頭籌",
			mp_mod_hu_desc = "雙方玩家玩完第一次底注，然後必須打出高過對方上一手嘅分數，否則就輸 ",
			mp_mod_enter_lobby_code = "輸入大廳代碼",
			mp_mod_join_clip = "從剪貼簿貼上",
			mp_mod_username = "用戶名稱:",
			mp_mod_enter_username = "輸入用戶名稱",
			mp_mod_join_discord = "加入",
			mp_mod_discord_name = "Balatro多人Discord",
			mp_mod_discord_msg = "你入到去可以同我哋匯報搵到嘅bugs同埋搵人陪你玩",
			mp_mod_enter_to_save = "按Enter儲存",
			mp_mod_in_lobby = "喺大廳",
			mp_mod_connected = "服務已連接",
			mp_mod_warn_service = "警告：無法找到多人伺服器",
			mp_mod_set_name = "可以係主選單設定自己嘅名(Mods > Multiplayer)",
			mp_mod_start = "開始",
			mp_mod_wait_for = "等緊",
			mp_mod_host_start = "大廳主開始",
			mp_mod_players = "其他玩家",
			mp_mod_lobby_options = "大廳設定",
			mp_mod_copy_clipboard = "複製到剪貼簿",
			mp_mod_connect_player = "已連接玩家:",
			mp_mod_view_code = "查看代碼",
			mp_mod_leave = "離開",
			mp_mod_opts_only_host = "只有大廳主能夠改呢啲設定",
			mp_mod_opts_cb_money = "死左會俾返啲錢東山再起",
			mp_mod_opts_no_gold_on_loss = "輸左回合會冇咗果個盲注嘅錢",
			mp_mod_opts_death_on_loss = "如果非PvP回合輸左會損失一條命",
			mp_mod_opts_start_antes = "一開始正常底注數目",
			mp_mod_opts_diff_seeds = "玩家有唔同嘅SEED",
			mp_mod_opts_lives = "命數",
			mp_mod_opts_gm = "模式修改效果",
			mp_mod_bl_pvp_name = "你嘅對手",
			mp_mod_bl_pvp_desc1 = "面對其他玩家，",
			mp_mod_bl_pvp_desc2 = "最多分數嘅人贏",
			mp_mod_or = "",
			mp_mod_life = "一係生",
			mp_mod_death = "一係死",
			mp_mod_lobby = "大廳",
			mp_mod_return_to = "返回",
			mp_mod_multiplayer_c = "多人遊戲",
		},
		v_dictionary = {
			a_xmult = "X#1#倍數",
