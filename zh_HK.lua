    ...
    descriptions = {
        Joker = {
            ...
            j_smeared = {
                name = "黏笠小丑",
                text = {
                    "{C:hearts}紅心{}同埋{C:diamonds}階磚",
                    "視為相同花色，",
                    "{C:spades}葵扇{}同埋{C:clubs}梅花",
                    "視為相同花色"
                },
                unlock = {
                    "牌組中至少",
